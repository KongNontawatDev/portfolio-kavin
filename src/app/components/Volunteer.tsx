...
export default function Volunteer() {
  ...
  return (
    <section className="bg-[#F5F3EF] flex items-center justify-center py-5 ">
      <Container className='text-center'>
        ...
        <div className="lg:flex lg:items-center lg:justify-center">
          <Image
            ...
            className="object-cover w-full max-w-2xl rounded-lg"
          />

          <div className="mt-8 lg:mt-0 lg:px-10">
          <h1 className="text-3xl mb-3 font-semibold text-gray-800 text-secondary">Volunteer</h1>
            <h2 className="text-2xl font-semibold text-gray-800 ">{projects[current].title}</h2>
            <p className="mt-4 text-gray-500 ">{projects[current].description}</p>
          </div>
        </div>

        <div className="flex items-center justify-center mt-10 space-x-4">
          <button onClick={prevSlide} className="p-2 text-gray-800  border rounded-full  hover:bg-gray-100 ">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
              <path strokeLinecap="round" strokeLinejoin="round" d="M15 19l-7-7 7-7" />
            </svg>
          </button>
          <button onClick={nextSlide} className="p-2 text-gray-800  border rounded-full  hover:bg-gray-100 ">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
